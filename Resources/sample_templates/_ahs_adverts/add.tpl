...
<div class="col-md-7">
    ...
    <form action="{{$form_path}}" method="post" >
        <div style="margin:8px 4px;">
            ...
            <input style="padding: 4px;height: 25px;width: 550px;" type="text" name="announcement[name]" value="{{ $announcement->getName() }}" placeholder="Podaj tytuł" />
        </div>
        ...
        <div style="margin:8px 4px;">
            ...
            <input style="padding: 4px;height: 25px;width: 150px;" type="text" name="announcement[price]" value="{{ $announcement->getPrice() }}" placeholder="Podaj cenę" /> zł
        </div>
        <div style="margin:8px 4px;">
            <input style="padding:4px;" type="checkbox" name="announcement[terms_accepted]" {{ if $announcement->getTermsAccepted() }}checked="checked" {{ /if }} value="1" />
